...
#define		NX				1024		/**< X Dimension in real space. Must be multiples of NPROC when using MPI.*/
#define		NY				1024		/**< Y Dimension in real space. Must be multiples of NPROC when using MPI.*/
#define		NZ				2		/**< Z Dimension in real space. */
...
#define   STS     //super time stepping method
// #define   RKL2    //super time stepping method
#define   NORMALIZED //redefine bouyancy variable
// #define   BNOISE

// #define   WITH_BRAGINSKII
