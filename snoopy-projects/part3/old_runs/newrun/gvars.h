...
#define		NX				256			/**< X Dimension in real space. Must be multiples of NPROC when using MPI.*/
#define		NY				2	/**< Y Dimension in real space. Must be multiples of NPROC when using MPI.*/
