...
DATADIR = "/Users/nityanigam/Desktop/Cambridge/HBI_project/david-runs/lapRe5e5-spectra"
...
make_fig(ky, ty, datay[:, 1, :], datay[:, 4, :],
          ...
          f"{DATADIR}/lines_fig1_parallel_field_parallel_dir.png")
...
make_fig(kx, tx, datax[:, 1, :], datax[:, 4, :],
          ...
          f"{DATADIR}/lines_fig2_parallel_field_horizontal_dir.png")
...
make_fig(ky, ty, v_horiz_y, b_horiz_y,
          ...
          f"{DATADIR}/lines_fig3_horizontal_field_parallel_dir.png")
...
make_fig(kx, tx, v_horiz_x, b_horiz_x,
          ...
          f"{DATADIR}/lines_fig4_horizontal_field_horizontal_dir.png")
